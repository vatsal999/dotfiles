...
let g:colors_name = 'ikigai'
" }}}
" Configuration: {{{
let s:configuration = {}
let s:configuration.style = get(g:, 'ikigai_style', 'pop')
let s:configuration.transparent_background = get(g:, 'ikigai_transparent_background', 0)
let s:configuration.menu_selection_background = get(g:, 'ikigai_menu_selection_background', 'green')
let s:configuration.disable_italic_comment = get(g:, 'ikigai_disable_italic_comment', 0)
let s:configuration.enable_italic = get(g:, 'ikigai_enable_italic', 0)
let s:configuration.enable_bold = get(g:, 'ikigai_enable_bold', 0)
let s:configuration.cursor = get(g:, 'ikigai_cursor', 'auto')
let s:configuration.current_word = get(g:, 'ikigai_current_word', get(g:, 'ikigai_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" BEIge AC9A83
" Palette: {{{
"
if s:configuration.style ==# 'pop'
  let s:palette = {
        \ 'black':      ['#1d1f21',   '237',  'DarkGrey'],
        \ 'bg0':        ['#1d1f21',   '235',  'Black'],
        \ 'bg1':        ['#1d1f21',   '236',  'DarkGrey'],
        \ 'bg2':        ['#1d1f21',   '236',  'DarkGrey'],
        \ 'bg3':        ['#2D2D2D',   '237',  'DarkGrey'],
        \ 'bg4':        ['#1d1f21',   '237',  'Grey'],
        \ 'bg_red':     ['#FF6161',   '203',  'Red'],
        \ 'diff_red':   ['#dd6161',   '52',   'DarkRed'],
        \ 'bg_green':   ['#99AD6A',   '107',  'Green'],
        \ 'diff_green': ['#8d9888',   '22',   'DarkGreen'],
        \ 'bg_blue':    ['#708bcc',   '110',  'Blue'],
        \ 'diff_blue':  ['#667899',   '17',   'DarkBlue'],
        \ 'fg':         ['#cfcfcf',   '250',  'White'],
        \ 'red':        ['#F28FAD',   '203',  'Red'],
        \ 'orange':     ['#F8BD96',   '215',  'Orange'],
        \ 'yellow':     ['#FAE3B0',   '179',  'Yellow'],
        \ 'green':      ['#C9E4C5',   '107',  'Green'],
        \ 'blue':       ['#7180AC',   '110',  'Blue'],
        \ 'purple':     ['#C9CBFF',   '176',  'Magenta'],
        \ 'grey':       ['#2e3141',   '246',  'LightGrey'],
        \ 'none':       ['NONE',      'NONE', 'NONE']
        \ }
elseif s:configuration.style ==# 'storm'
  let s:palette = {
        \ 'black':      ['#262525',   '237',  'DarkGrey'],
        \ 'bg0':        ['#1D2021',   '235',  'Black'],
        \ 'bg1':        ['#313234',   '236',  'DarkGrey'],
        \ 'bg2':        ['#262525',   '236',  'DarkGrey'],
        \ 'bg3':        ['#262525',   '237',  'DarkGrey'],
        \ 'bg4':        ['#323131',   '237',  'Grey'],
        \ 'bg_red':     ['#a05151',   '203',  'Red'],
        \ 'diff_red':   ['#a05151',   '52',   'DarkRed'],
        \ 'bg_green':   ['#8d987e',   '107',  'Green'],
        \ 'diff_green': ['#8d987e',   '22',   'DarkGreen'],
        \ 'bg_blue':    ['#8BA6C5',   '110',  'Blue'],
        \ 'diff_blue':  ['#30475E',   '17',   'DarkBlue'],
        \ 'fg':         ['#cfcfcf',   '250',  'White'],
        \ 'red':        ['#cc6464',   '203',  'Red'],
        \ 'orange':     ['#E49273',   '215',  'Orange'],
        \ 'yellow':     ['#F3C292',   '179',  'Yellow'],
        \ 'green':      ['#859e82',   '107',  'Green'],
        \ 'blue':       ['#7180AC',   '110',  'Blue'],
        \ 'purple':     ['#aaa1c8',   '176',  'Magenta'],
        \ 'grey':       ['#7a7876',   '246',  'LightGrey'],
        \ 'none':       ['NONE',      'NONE', 'NONE']
        \ }
elseif s:configuration.style ==# 'bran'
  let s:palette = {
        \ 'black':      ['#262525',   '237',  'DarkGrey'],
        \ 'bg0':        ['#201E1A',   '235',  'Black'],
        \ 'bg1':        ['#313234',   '236',  'DarkGrey'],
        \ 'bg2':        ['#262525',   '236',  'DarkGrey'],
        \ 'bg3':        ['#262525',   '237',  'DarkGrey'],
        \ 'bg4':        ['#323131',   '237',  'Grey'],
        ...
        \ 'fg':         ['#766A5C',   '250',  'White'],
        \ 'red':        ['#624642',   '203',  'Red'],
        \ 'orange':     ['#7F6141',   '215',  'Orange'],
        \ 'yellow':     ['#806A52',   '179',  'Yellow'],
        \ 'green':      ['#5E6052',   '107',  'Green'],
        \ 'blue':       ['#505C5C',   '110',  'Blue'],
        \ 'purple':     ['#5E4D4C',   '176',  'Magenta'],
        \ 'grey':       ['#423A37',   '246',  'LightGrey'],
        \ 'none':       ['NONE',      'NONE', 'NONE']
        \ }
endif
...
if s:configuration.enable_italic
  ...
  call s:HL('Type', s:palette.orange, s:palette.none, 'bold')
...
call s:HL('Include', s:palette.blue, s:palette.none)
